  ...
  return (
    <Layout>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <MetricCard label="申请数" value={String(applications.length)} />
        <MetricCard label="已通过" value={String(approved)} tone="lime" />
        <MetricCard label="已放款" value={String(funded)} tone="amber" />
        <MetricCard label="申请总额" value={formatUsdt(totalBorrowed)} tone="aqua" />
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
        <section className="rounded-md border border-line bg-panel p-5 shadow-glow">
          ...
          <h2 className="mt-2 text-xl font-semibold">隐私字段</h2>
